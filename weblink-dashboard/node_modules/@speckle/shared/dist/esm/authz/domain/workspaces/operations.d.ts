...
export type GetWorkspaceRole = (args: UserContext & WorkspaceContext) => Promise<WorkspaceRoles | null>;
export type GetWorkspaceLimits = (args: WorkspaceContext) => Promise<WorkspaceLimits | null>;
export type GetWorkspacePlan = (args: WorkspaceContext) => Promise<WorkspacePlan | null>;
export type GetWorkspaceProjectCount = (args: WorkspaceContext) => Promise<number | null>;
export type GetWorkspaceModelCount = (args: WorkspaceContext) => Promise<number | null>;
export type GetWorkspaceSeat = (args: UserContext & WorkspaceContext) => Promise<WorkspaceSeatType | null>;
export type GetWorkspaceSsoProvider = (args: WorkspaceContext) => Promise<WorkspaceSsoProvider | null>;
export type GetWorkspaceSsoSession = (args: UserContext & WorkspaceContext) => Promise<WorkspaceSsoSession | null>;
