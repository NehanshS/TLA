...
export const loadMultiRegionsConfig = async ({ path }) => {
    let file;
    try {
...
export const createKnexConfig = ({ connectionString, migrationDirs, isTestEnv, isDevOrTestEnv, logger, maxConnections, caCertificate, connectionAcquireTimeoutMillis, connectionCreateTimeoutMillis, asyncStackTraces }) => {
...
export const configureKnexClient = (config, configArgs) => {
