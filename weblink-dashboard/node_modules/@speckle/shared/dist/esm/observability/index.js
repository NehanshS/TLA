...
const defaultLogFormatterFactory = (pretty) => (logObject) => pretty ? logObject : toClef(logObject);
export function getLogger(minimumLoggedLevel = 'info', pretty = false, mixin) {
    if (logger)
        return logger;
    const pinoOptions = {
